    ...
    def procesar():
        try:
            ...
            if not os.path.exists(nav_path):
                # LISTA DE ESPEJOS Y NOMBRES ALTERNATIVOS (FALLBACKS)
                urls_to_try = [
                    # 1. El estándar consolidado (a veces tarda en publicarse)
                    f"https://igs.bkg.bund.de/root_ftp/IGS/BRDC/{year}/{doy:03d}/BRDC00IGS_R_{year}{doy:03d}0000_01D_MN.rnx.gz",
                    # 2. El consolidado de la agencia DLR (Suele estar disponible mucho antes)
                    f"https://igs.bkg.bund.de/root_ftp/IGS/BRDC/{year}/{doy:03d}/BRDM00DLR_S_{year}{doy:03d}0000_01D_MN.rnx.gz",
                    # 3. Alternativa secundaria de BKG
                ...
                for url_nav in urls_to_try:
                    try:
                        ...
                        break # Salimos del loop porque ya lo descargamos
